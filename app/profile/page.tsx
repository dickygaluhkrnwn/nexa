        ...
        <div className="bg-card border border-border/60 rounded-[2rem] p-5 shadow-sm space-y-5 transition-all hover:shadow-md">
          ...
          <div className="flex items-center justify-between pt-1">
            ...
            >
              ...
              <span
                className={`pointer-events-none inline-block h-6 w-6 transform rounded-full bg-background shadow-md ring-0 transition duration-300 ease-in-out ${vibrationEnabled ? 'translate-x-5' : 'translate-x-0'}`}
              />
            </button>
          </div>
          ...
          <div>
            {isEditingWA ? (
              <div className="space-y-4 animate-in fade-in slide-in-from-top-2 duration-300 bg-muted/30 p-4 rounded-2xl border border-border/50">
                ...
                <div className="flex gap-2 pt-1">
                  <Button variant="outline" onClick={() => setIsEditingWA(false)} disabled={isSaving} className="flex-1 rounded-xl h-11 font-bold">
                    Batal
                  </Button>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <p className="text-base font-extrabold text-foreground/80">
                    {whatsapp ? (
                      ...
                      <span className="font-medium text-muted-foreground/80 italic text-sm">Belum dihubungkan</span>
                    )}
                  </p>
                </div>
              </div>
